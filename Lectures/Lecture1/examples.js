...
console.log("name: ", name + "course: " + " month: " + month);
...
/*******************************************
 ...
 3.  console.log all items in one string wth spaces
...
if ((weather === "sunny") && (waves === 9, 8, 7, 6, 5)) {
    ...
    console.log("bobsMood is bummed");

}
if ((weather === "overcast") && (waves === 10, 9, 8, 7)) {
    console.log("jackedUp");
}
if ((weather === "overcast") && (waves ===  6, 5, 4, 3)) {
    console.log("Bummed");
}
if ((weather === "overcast") && (waves === 2, 1, 0)) {
 ...
 ********************************************/
var temp = 60;
student1 = (weather === 'Sunny') ? console.log ("student is happy") : console.log ("student is sad");
temp>=80 ? console.log("student is content") : console.log ("student is sad");
