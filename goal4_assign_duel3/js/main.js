...
(function(){
    ...
    console.log("FIGHT!!!");
var playerOne = ['playerOneName', 'player1Damage', 'playerOneHealth'];//  more efficient array for player info
var playerTwo = ['playerTwoName', 'player2Damage', 'playerTwoHealth'];
    //player name
