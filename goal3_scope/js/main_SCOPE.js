...
var nameFN = function(var1){ // var1 will be replaced by the value within the function call it is a place holder.
	var firstName = var1;
	var lastName = "bond";
...
*******************************************************************************/  
 //--------------------------------------------------------
    console.log("4. sentence char count");
     ...
     var string = ['james', 'bond', 'ninja'];

var charCount = function(var1){ 
	var length = var1;
	var answer = string.length;
	console.log("the length of the array is ", answer);
...
var test = vowelsInWord(word);
	console.log("The answer outside of the function is ", test);
